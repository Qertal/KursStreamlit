...
def main():
    ...
    st.markdown("<p style='color:lightgreen'> Streamlit is Awesome </p>",unsafe_allow_html=True)
...
function showSlides(n) {
  ...
  dots[slideIndex-1].className += " active";
    ...
    stc.iframe("https://jcharistech.com",height=300, width=400, scrolling=True)
